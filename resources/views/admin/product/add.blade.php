                ...
                <form id="addCategoryForm" action="/add-product" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input autocomplete="off" required placeholder="Enter product name" class="form-control mb-3 @error('product_name') is-invalid @enderror" type="text" id="product_name" name="product_name">
                            @error('product_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <label>Product Price<span style="color:#ff0000">*</span></label>
                            <input autocomplete="off" required placeholder="Enter product price" class="form-control  @error('product_price') is-invalid @enderror" type="number" id="product_price" name="product_price">
                            @error('product_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
