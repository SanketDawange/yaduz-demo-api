...
<style>
    .my-alert{
        ...
        right: 30%;
        top: 1%;
        box-shadow: 3px 3px 3px 3px rgba(167, 167, 167, 0.448);
    }
</style>
</head>
<!-- END : Head-->
        ...
        <div class="app-sidebar menu-fixed" data-background-color="man-of-steel" data-image="../../../app-assets/img/sidebar-bg/01.jpg" data-scroll-to-active="true">
            ...
            <div class="sidebar-header">
                <div class="logo clearfix"><a class="logo-text float-left" href="index.html">
                        <div class="logo-img"><img src="../../../app-assets/img/logo.png" alt="Apex Logo" /></div><span class="text">APEX</span>
            ...
            <div class="sidebar-content main-menu-content">
                <div class="nav-container">
                    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                        <li class="nav-item"><a href="/"><i class="ft-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
                        </li>
                        <li class="has-sub nav-item"><a href="javascript:;"><i class="ft-grid"></i><span class="menu-title" data-i18n="Master">Master</span></a>
                            <ul class="menu-content">
                                <li class="nav-item"><a href="/categories"><i class="ft-arrow-right"></i><span class="menu-title" data-i18n="Email">Categories</span></a></li>
                                <li class="nav-item"><a href="/products"><i class="ft-arrow-right"></i><span class="menu-title" data-i18n="Chat">Products</span></a></li>
                            </ul>
                        </li>
                        <li class="has-sub nav-item"><a href="javascript:;"><i class="icon-handbag"></i><span class="menu-title" data-i18n="Task Board">Orders</span></a>
                            <ul class="menu-content">
                                <li class="nav-item"><a href="/orders"><i class="ft-arrow-right"></i><span class="menu-title" data-i18n="Email">Order List</span></a></li>
                            </ul>
                        </li>
